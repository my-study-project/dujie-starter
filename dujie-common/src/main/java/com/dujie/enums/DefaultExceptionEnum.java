...
import com.dujie.exception.ErrorTypeException;
import lombok.Getter;

@Getter
public enum DefaultExceptionEnum implements ErrorTypeException {
    /**
     * 通用异常信息ErrorType
     **/
    ...
    DefaultExceptionEnum(String codeException, String describe) {
